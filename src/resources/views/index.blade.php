...
@section('content')
<div class="page page--product-create bg-gray-50">
    <div class="container mx-auto max-w-3xl py-12">

        <h1 class="heading heading--lv1 mb-8">商品登録</h1>

        <form class="form form--product card p-8" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf

            {{-- 商品名 --}}
            <div class="form__group">
                <label for="name" class="form__label">
                    商品名 <span class="badge badge--required">必須</span>
                </label>
            ...
            <div class="form__group">
                <label for="price" class="form__label">
                    値段 <span class="badge badge--required">必須</span>
                </label>
            ...
            <div class="form__group">
                <label for="image" class="form__label">
                    商品画像 <span class="badge badge--required">必須</span>
                </label>
            ...
            <div class="form__group">
                <div class="form__label">
                    季節 <span class="badge badge--required">必須</span>
                    <span class="form__note"> 複数選択可</span>
                </div>
            ...
            <div class="form__group">
                <label for="description" class="form__label">
                    商品説明 <span class="badge badge--required">必須</span>
                </label>
            ...
            <div class="form__actions">
                <a href="{{ url()->previous() }}" class="btn btn--ghost">戻る</a>
